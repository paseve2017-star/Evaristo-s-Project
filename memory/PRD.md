...
- User guided on com0com (2026-09-03): signed v3.0.0.0 from SourceForge (com0com-3.0.0.0-i386-and-x64-signed.zip), default pair CNCA0/CNCB0 renamed via setupg/setup command `change CNCA0 PortName=COM3` etc. NmeaPort writes COM3, bridge reads COM4.
